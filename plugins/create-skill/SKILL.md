...
**Note**: `~/.cursor/skills-cursor/` may be a user-managed skills repo (e.g. symlinked from a project). Check project docs (e.g. CURSOR_SKILLS_REPO.md) for the intended skills path before creating new skills.
