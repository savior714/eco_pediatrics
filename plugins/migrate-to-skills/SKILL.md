...
- When migrating, do not overwrite existing skills in ~/.cursor/skills-cursor. That directory may contain the project's canonical skills repo—only add new skills or update with explicit user approval.
