...
export function IVStatusCard({ photoUrl, dropsPerMin, lastChecked }: IVStatusCardProps) {
    return (
        <Card className="flex flex-col gap-4 bg-blue-50 border-blue-100 shadow-sm">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                ...
                <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-bold text-slate-800">{dropsPerMin || 0}</span>
                    <span className="text-slate-500 font-medium">gtt</span>
                </div>
            </div>
        </Card>
    );
