...
export function PatientDetailSidebar({
    ...
    const sidebarTabs = [
        {
            label: `요청 사항 (${displayNotifications.length})`,
            value: 'notifications',
            content: (
                <section className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm min-h-[300px]">
        ...
        },
        {
            ...
            value: 'docs',
            content: (
                <section id="patient-sidebar-completed-docs" className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm min-h-[300px]">
                    <h3 className="text-sm font-bold text-slate-700 mb-4 flex items-center gap-2">
    ...
    return (
        <div className="lg:col-span-5 h-full">
            <Tabs defaultValue="notifications" tabs={sidebarTabs} />
        </div>
    );
}
